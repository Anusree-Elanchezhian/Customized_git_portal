...
const Anniversary = () => {
  const birthdayCardsData = [
    {
      imageUrl:'https://res.cloudinary.com/ddlw9iej1/image/upload/v1708754331/pic1_qhc9bj.jpg',
      title: 'Happiest Birthday Cupcake Mug',
      description: 'Rs.399.00',
    },
    {
      imageUrl: 'https://res.cloudinary.com/ddlw9iej1/image/upload/v1708754487/pic3_sl7x0t.jpg',
