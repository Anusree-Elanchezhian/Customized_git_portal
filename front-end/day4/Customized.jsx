...
const Customized = () => {
  const birthdayCardsData = [
    {
      imageUrl:'https://res.cloudinary.com/ddlw9iej1/image/upload/v1708754332/pic2_hgtxkc.jpg',
      title: 'Happiest Birthday Cupcake Mug',
      description: 'Rs.399.00',
    },
    {
      imageUrl: 'https://res.cloudinary.com/ddlw9iej1/image/upload/v1708754487/pic2_zykiyy.jpg',
      title: 'Personalised Choco Bar for Birthday',
      description: 'Rs.475.00',
    },
    {
        imageUrl: 'https://res.cloudinary.com/ddlw9iej1/image/upload/v1708754487/pic1_x4qf5v.jpg',
